              ...
              <li>contact      information including email address</li>
                <li>demographic      information such as postcode, preferences and interests</li>
                  ...
                  <p><strong>What we do with the information we gather</strong> <br>
                    We may use the information provided for the following reasons:</p>
                    <ul>
...
<p><strong>Promoter</strong> <br>
  The promoter is <?php echo $company; ?>, <?php echo $address; ?>, <?php echo $tel; ?>.<br>
    </p><p> <strong>Participants</strong></p>
    <ol start="2" type="1">
      <ol start="1" type="1">
...
<p><strong>Errors and Omissions:</strong> <br>
  While every care has been exercised in presenting this competition, <?php echo $company; ?> accepts no responsibility for errors or omissions.</p>
<?php //End HTML
}
